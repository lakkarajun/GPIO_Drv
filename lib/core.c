...
gpiod_chip_get_line(struct gpiod_chip *chip, unsigned int offset)
{
    ...
    printf("Raju:%s: chip:%s, GPIO:%d\n", __func__, chip->name, offset);
...
int gpiod_line_update(struct gpiod_line *line)
{
    ...
    printf("Raju:%s: Dir:%d, State:%d, Used:%d, \nOpenDrain:%d, OpenSource:%d, consumer:%s\n", __func__, line->direction, line->active_state, line->used, line->open_drain, line->open_source, info.consumer);
			  ...
			  struct gpiod_line_event *event)
{
    ...
    printf("\n%s: CHIP:%s, GPIO:%d\n", __func__, line->chip->name, line->offset);
